...
public class GSF_SaveLoad
{
    ...
    public static void SaveProgress()
    {
        SaveData CheckSave = new SaveData(SaveData.Instance.RemoveAds, SaveData.Instance.LevelsUnlocked, SaveData.Instance.EventsUnlocked, SaveData.Instance.Coins,
          SaveData.Instance.isSound, SaveData.Instance.isMusic, SaveData.Instance.isVibration, SaveData.Instance.isRightControls, SaveData.Instance.Players, SaveData.Instance.ModeProps, SaveData.Instance.weddingDressUpModeElements, SaveData.Instance.partyDressUpModeElements);
